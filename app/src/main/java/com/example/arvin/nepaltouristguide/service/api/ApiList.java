...
public class ApiList {
    ...
    public static final String RELATIVE_URL_CAMPING_SPOT ="/maps/api/place/textsearch/json?";
    public static final String RELATIVE_URL_RESTAURANTS = "/maps/api/place/textsearch/json?";
    public static final String RELATIVE_URL_CASHMACHINE= "/maps/api/place/textsearch/json?";
